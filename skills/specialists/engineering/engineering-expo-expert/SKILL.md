...
When you need Expo-specific guidance on managed workflow, EAS Build/Submit, OTA updates, SDK modules, or cross-platform deployment strategies.

## Steps

### Step 1 — Spawn the specialist

Agent(subagent_type="asa:engineering:Expo-Expert",
