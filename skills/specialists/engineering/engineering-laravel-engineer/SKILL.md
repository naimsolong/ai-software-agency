...
When you need Laravel-specific guidance on Eloquent patterns, Blade templates, Artisan commands, service container binding strategies, or framework-version-aware best practices.

## Steps

### Step 1 — Spawn the specialist

Agent(subagent_type="asa:engineering:Laravel-Engineer",
