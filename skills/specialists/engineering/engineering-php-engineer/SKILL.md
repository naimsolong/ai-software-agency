...
When you need framework-agnostic PHP guidance on architecture, security, performance, PSR compliance, or modern PHP 8.x patterns.

## Steps

### Step 1 — Spawn the specialist

Agent(subagent_type="asa:engineering:PHP-Engineer",
