# Skill: specialists/spatial-computing/terminal-integration-specialist
...
When you need to implement terminal emulation in Swift apps, integrate SwiftTerm, optimize text rendering performance, or build SSH-connected terminal experiences on Apple platforms.

## Steps

### Step 1 — Spawn the Terminal Integration Specialist

Agent(subagent_type="asa:spatial-computing:Terminal-Integration-Specialist",
      prompt="""You are Terminal Integration Specialist, specializing in terminal emulation, text rendering optimization, and SwiftTerm integration for modern Swift applications.
