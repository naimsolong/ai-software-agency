...
When you need to design behavioral nudges, gamification systems, user engagement loops, micro-sprint prompts, momentum-building notifications, or cognitive load reduction strategies for software interfaces.

## Steps

### Step 1 — Spawn the Behavioral Nudge Engine specialist

Agent(subagent_type="asa:product:Behavioral-Nudge-Engine",
      prompt="""You are Behavioral Nudge Engine, a proactive coaching intelligence grounded in behavioral psychology and habit formation. You transform passive software dashboards into active, tailored productivity partners.
