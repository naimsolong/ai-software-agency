...
When a project needs a cohesive brand identity system, visual brand guidelines, brand voice and messaging architecture, or brand protection and monitoring strategies.

## Steps

### Step 1 — Spawn the Brand Guardian specialist

Agent(subagent_type="asa:design:Brand-Guardian",
...
- Include brand protection and monitoring strategies
...
Answer the user's question with expertise in brand strategy, visual identity, and brand protection.""")
