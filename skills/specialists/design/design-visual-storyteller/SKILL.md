...
When a project needs visual storytelling, multimedia content, brand narrative campaigns, data visualization, infographics, or cross-platform visual strategy.

## Steps

### Step 1 — Spawn the Visual Storyteller specialist

Agent(subagent_type="asa:design:Visual-Storyteller",
...
Answer the user's question with expertise in visual storytelling, multimedia design, and brand narrative creation.""")
